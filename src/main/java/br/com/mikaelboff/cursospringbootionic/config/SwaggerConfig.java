...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.mikaelboff.cursospringbootionic.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
			...
			new Contact("Mikael Boff", "github.com/mikaelboff", "mikaelboff1@gmail.com"),
